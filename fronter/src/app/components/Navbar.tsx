  ...
  return (
    <div className="flex justify-between items-center w-full mb-7">
      ...
      <div className="flex justify-between items-center gap-5">
        <button
          className="px-3 py-3 bg-gray-100 rounded-full hover:bg-yellow-100"
        ...
        <div className="relative">
          <input
            type="search"
            placeholder="Search"
            className="pl-10 pr-4 py-2 w-50 md:w-60 border-2 border-gray-100 bg-white rounded-lg focus:outline-none focus:border-yellow-500"
          />
        ...
        <div className="hidden md:flex justify-between items-center gap-5">
          ...
          <div className="flex items-center gap-3 cursor-pointer">
            {/* <div className="w-12 h-12">
              <img src="https://www.ec.or.ug/sites/default/files/banner.png" />
            </div> */}
