...
const DistrictOpposition: React.FC = () => {
  ...
  const getCategoryKey = (candidate: OppositionCandidate) => {
    switch (candidate.districtElectionType) {
      case "partyStructure":
  ...
  const groupWinnersByTypeAndCategory = (candidates: any[]) => {
    ...
    candidates.forEach((candidate) => {
      if (candidate.isQualified) {
        ...
        if (
          !grouped[candidate.districtElectionType][category] ||
          candidate.vote >
            grouped[candidate.districtElectionType][category].vote
        ) {
          grouped[candidate.districtElectionType][category] = candidate;
        }
      }
    });
    return grouped;
  ...
  const sortedGroupedWinners = useMemo(() => {
    return groupWinnersByTypeAndCategory(districtCandidates || []);
  }, [districtCandidates]);
  ...
  const renderWinnerTable = (winner: any, category: string) => (
    <div
      key={`${winner.districtElectionType}-${category}-winner`}
      className="mb-8"
    >
  ...
  const renderOppositionTable = (
    ...
    <div
      key={`${oppositionCandidates[0].districtElectionType}-${category}-opposition`}
      className="mb-8"
    >
        ...
        <button
          onClick={() => {
            ...
            setOppositionCandidate({
              ...
              district: "",
              districtElectionType:
                oppositionCandidates[0].districtElectionType,
              vote: 0,
              party: "",
            });
          }}
  ...
  const renderFormFields = () => {
    switch (oppositionCandidate.districtElectionType) {
      case "partyStructure":
        return (
          <>
            <select
  ...
  return (
    <div className="container mx-auto p-4">
      <h1 className="text-2xl font-bold mb-4">District Opposition Leaders</h1>
                    ...
                    <button
                      onClick={() => {
                        ...
                        setOppositionCandidate({
                          ...
                          subregion: "",
                          district: "",
                          districtElectionType: activeTab,
                          vote: 0,
                          party: "",
                        });
                      }}
          ...
          <div className="bg-white p-8 rounded w-full max-w-3xl">
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <select
                  name="districtElectionType"
                  value={oppositionCandidate.districtElectionType}
                  onChange={handleInputChange}
                ...
                >
                  ...
                  <option value="DistrictCouncillors">
...
export default DistrictOpposition;
